...
const ASSETS = [
  ...
  './js/ui/dom.js', './js/ui/projects.js', './js/ui/list.js', './js/ui/catalog.js', './js/ui/export.js', './logos/index.json', './js/compat.js', './js/lens.js', './js/ui/icons-dept.js', './data/compat.json', './js/ui/news.js', './data/news.json', './data/changes.json', './data/extra.json',

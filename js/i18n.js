...
export const dict = {
  he: {
    ...
    dept_video: 'וידאו', dept_tripods: 'חצובות', dept_power: 'סוללות וכוח', jump_to_brand: 'קפיצה ליצרן', optional: 'אופציונלי', hero_sub: 'רשימות ציוד להפקות', stat_products: 'מוצרים', stat_brands: 'יצרנים', stat_projects: 'פרויקטים',
    ...
    theme: 'מצב תצוגה', home: 'בית', back_btn: 'חזרה', menu: 'תפריט', version: 'גרסה', date: 'תאריך', received_by: 'התקבל על ידי · חתימה', date_received: 'תאריך קבלה', dates: 'ימי צילום', contact: 'ליצירת קשר', include_images: 'תמונות מוצר בהדפסה', production_co: 'חברת הפקה', phone: 'טלפון', email: 'אימייל', doc_lang: 'שפת המסמך', filters: 'סינון מהיר', f_type: 'סוג', f_mount: 'מאונט', f_format: 'פורמט',
  ...
  en: {
    ...
    dept_video: 'Video', dept_tripods: 'Tripods & Heads', dept_power: 'Power', jump_to_brand: 'Jump to brand', optional: 'optional', hero_sub: 'Production gear lists', stat_products: 'products', stat_brands: 'brands', stat_projects: 'projects',
    ...
    theme: 'Display mode', home: 'Home', back_btn: 'Back', menu: 'Menu', version: 'Version', date: 'Date', received_by: 'Received by · signature', date_received: 'Date received', dates: 'Shoot dates', contact: 'Contact', include_images: 'Product photos when printing', production_co: 'Production company', phone: 'Phone', email: 'Email', doc_lang: 'Document language', filters: 'Quick filters', f_type: 'Type', f_mount: 'Mount', f_format: 'Format',

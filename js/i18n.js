...
export const dict = {
  ...
  en: {
    ...
    tools: 'Tools', versions: 'Versions', save_version: 'Save current version', version_label: 'Version name (optional)', restore: 'Restore', no_versions: 'No versions saved yet', version_saved: 'Version saved', version_restored: 'Version restored', before_restore: 'before restore', auto_version: 'Automatic version', items_in_version: '{n} items', theme: 'Display mode', home: 'Home', back_btn: 'Back', menu: 'Menu', version: 'Version', date: 'Date', received_by: 'Received by · signature', date_received: 'Date received', dates: 'Shoot dates', contact: 'Contact', include_images: 'Product photos when printing', production_co: 'Production company', phone: 'Phone', email: 'Email', doc_lang: 'Document language', filters: 'Quick filters', f_type: 'Type', f_mount: 'Mount', f_format: 'Format',

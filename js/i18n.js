...
export const dict = {
  he: {
    ...
    date: 'תאריך', received_by: 'התקבל על ידי · חתימה', date_received: 'תאריך קבלה', dates: 'ימי צילום', contact: 'ליצירת קשר', include_images: 'תמונות מוצר בהדפסה', production_co: 'חברת הפקה', phone: 'טלפון', email: 'אימייל', doc_lang: 'שפת המסמך', filters: 'סינון מהיר', f_type: 'סוג', f_mount: 'מאונט', f_format: 'פורמט',
  ...
  en: {
    ...
    date: 'Date', received_by: 'Received by · signature', date_received: 'Date received', dates: 'Shoot dates', contact: 'Contact', include_images: 'Product photos when printing', production_co: 'Production company', phone: 'Phone', email: 'Email', doc_lang: 'Document language', filters: 'Quick filters', f_type: 'Type', f_mount: 'Mount', f_format: 'Format',
